...
const blogData = {
  ...
  date: "31 Mar 2026",
  mainImage: "/assets/24-hours-hotel-guwahati (1).webp",
  ...
  sections: [
    {
      ...
      content: "The primary advantage of booking your hotels in Guwahati with Atithi Homes is that we are close to Pratiksha Hospital, Guwahati. So, choosing a 24 Hours Hotel in Guwahati, the Atithi Homes, can be effective during any emergency. <br/><br/>Our hotel is always open and close to the best hospital. So, patients and their relatives will always get a second home feeling all the time. We categorize our services effectively to maintain the inner peace of patients and attendants. We provide a peaceful retreat for those navigating the challenges of hospital visits. <br/><br/>Reach out via the Atithi Home contact number for immediate room availability near the hospital."
    },
    {
    ...
    },
    {
      ...
      content: "The <a href=\"/\" class=\"text-[#1E3A8A] font-bold hover:underline\">Atithi Home Guwahati</a> is the right choice for any type of top medical case in any hour. With our hotel rooms, where we offer a level of cleanliness and hygiene, it is always easy to keep your mind relaxed and get the best level of treatment for your patients. <br/><br/>Let’s take a look at the strategies that make us the best 24 Hours Hotel in Guwahati:<br/><br/>Flexible extensions<br/>Compassionate pricing<br/>Hygienic standards<br/><br/>Wait no further during any medical emergency? <a href=\"/contact\" class=\"text-[#1E3A8A] font-bold hover:underline\">Contact</a> the Atithi Home immediately for priority booking and empathetic service."
    },
    {
      title: "Conclusion",
      content: "Whether you are seeking a 24/7 hotel near Pratiksha Hospital for medical reasons or simply need a hotel open now in Guwahati after a late-night adventure, choose Atithi Homes. <br/><br/>Check out the full amenity list at Atithi Home Guwahati and upgrade your stay."
    }
  ],
  faqs: [
    {
    ...
    },
    {
      ...
      a: "Call to our <a href=\"tel:+916000891365\" class=\"text-[#1E3A8A] font-bold hover:underline\">Atithi Home contact number</a> immediately if you want any kind of support you require at any point of time."
    },
    {
