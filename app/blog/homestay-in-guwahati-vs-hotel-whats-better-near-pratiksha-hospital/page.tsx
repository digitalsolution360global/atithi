...
const blogData = {
  ...
  introduction: "Accommodation within the Homestay in Guwahati is important in every stay that a passenger always seeks when he or she travels to a perfect destination or any hospital-related stay in Guwahati. At Atithi Homes, we bridge the gap between top-rated hoteling experience and specialized healthcare. <br/><br/>For those seeking a guest house near Pratiksha Hospital, Atithi Homes provides a specialized experience. Our hoteling services outweigh the standardized services of luxury chains. <br/><br/>In these areas, we provide a superior choice for patients, families, and travelers alike. Time to get a more cost-effective experience than a standard hotel, specifically for those visiting Pratiksha Hospital. <br/><br/>Experience the warmth of local hospitality at Atithi Homes—book your peaceful retreat today!",
  sections: [
    {
      ...
      Don’t let traffic add to your stress; stay at Atithi Homes, just minutes from Pratiksha Hospital. Call us now!`
    },
    {
